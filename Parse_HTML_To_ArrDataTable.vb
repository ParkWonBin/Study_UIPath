Dim Fnc_GetTags As System.Func(Of String,String,String, String()) = Function(Source As String, TagName As String, contents As String) As String()
...
Dim Fnc_Extract_Tabels As System.Func(Of String, System.Data.DataTable()) = Function(HTML As String) As System.Data.DataTable()
